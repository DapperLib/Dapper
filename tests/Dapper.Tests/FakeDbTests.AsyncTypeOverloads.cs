...
namespace Dapper.Tests
{
    ...
    public class FakeDbAsyncTypeOverloadTests
    {
        ...
        private class TypeWithField { public int Id = 0; }

        [Fact]
        public void DefaultTypeMap_MapsColumnToPublicField_WhenNoMatchingProperty()
        {
            using var conn = new fakeDbConnection(new FakeDataStore());
            conn.EnqueueReaderResult(new[]
            {
            ...
            var result = conn.QueryFirst<TypeWithField>("SELECT Id FROM Items");
