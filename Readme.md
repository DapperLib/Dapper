...
| Package | NuGet Stable | NuGet Pre-release | Downloads | MyGet | Purpose |
| ------- | ------------ | ----------------- | --------- | ----- | ------- |
