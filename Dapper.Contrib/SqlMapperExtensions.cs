...
namespace Dapper.Contrib.Extensions
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        private static IEnumerable<PropertyInfo> KeyPropertiesCache(Type type)
        {
            ...
            {
                var idProp = allProperties.Where(p => p.GetColumnName().ToLower() == "id").FirstOrDefault();
                if (idProp != null)
                {
        ...
        public static T Get<T>(this IDbConnection connection, dynamic id, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            if (!GetQueries.TryGetValue(type.TypeHandle, out sql))
            {
                ...
                sql = "select * from " + name + " where " + onlyKey.GetColumnName() + " = @id";
        ...
        {
            // Find the column mapping attribute
            var colAttr = property.GetCustomAttributes(false)
                .FirstOrDefault(a => a.GetType().Name == ColumnAttributeTypeMapper<dynamic>.ColumnAttributeName);
            if (colAttr != null) // Return value of Name property
                return colAttr.GetType().GetProperty("Name").GetValue(colAttr, null).ToString();
        ...
        public static long Insert<T>(this IDbConnection connection, T entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            for (var i = 0; i < allPropertiesExceptKey.Count(); i++)
            {
                ...
                sbColumnList.AppendFormat("[{0}]", property.GetColumnName());
